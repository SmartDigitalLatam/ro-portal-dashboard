...
export default class pressao_diferencial_mes extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      options: {
        ...
        title: {
          text: 'Pressão Diferencial Mensal',
          align: 'center'
        },
        markers: {
          size: 0
        ...
        yaxis: {
          max: 2, // Here goes the max value for the Y axis .
          min: -2,
          range: 500,
          title: {
            text: 'kgf/cm²',
  ...
  componentDidMount() {
    ...
    let RejeicaoNormalizadaDeSalDoPermeado = funcRejeicaoNormalizadaDeSalDoPermeado(vazaoPermeadoI, condutividadeEntradaI, PassagemNormalizadaDeSalDoPermeado, TDSFeedI);
      ...
      */
      let obj = { x:formated_date, y: parseFloat(pressaoDiferencialI) };
      add = add + 100;
      data_list.push(obj);
