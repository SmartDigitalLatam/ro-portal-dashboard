...
class vazao_normalizada_permeado extends Component{
    constructor(props){
        super(props);
        this.state = {
            chartData:{}
           ...
           value.map(function(i){
            ...
            this.setState({
                chartData:{
                    ...
                    datasets: [
                        {
                            label: "Vazão Normalizada Permeado (m³/h)",
                            data: vazao_normalizada_permeado,
                            lineTension: 0.1,
                            fill:false,
    ...
    render(){
        return(
            <div className = "vazao_normalizada_permeado">
                ...
                <Line
                    ...
                    options={{
                        title:{
                            display: true,
                            text: 'Vazão Normalizada Permeado (m³/h)',
                            fontSize: 30
                        },
                        legend:{
                            display:false,
...
export default vazao_normalizada_permeado;