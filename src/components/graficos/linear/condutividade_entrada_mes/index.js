...
export default class condutividade_entrada_mes extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      options: {
        chart: {
          ...
          animations: {
            ...
            easing: 'linear',
            dynamicAnimation: {
              speed: 8000 // The speed that the chart'll connect 2 lines .
            }
          },
          zoom: {
            type: 'x',
        ...
        title: {
          text: 'Condutividade da Entrada Mensal',
          align: 'center'
        },
        markers: {
          size: 0
